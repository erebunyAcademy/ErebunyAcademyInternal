  ...
  useMemo(() => {
    if (selectedSchedule) {
      ...
      reset({
        ...
        startDayDate: dayjs(selectedSchedule.startDayDate).format('DD-MM-YYYY'),
        examDate: dayjs(selectedSchedule.examDate).format('DD-MM-YYYY'),
        endDayDate: dayjs(selectedSchedule.endDayDate).format('DD-MM-YYYY'),
